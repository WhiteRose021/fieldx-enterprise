  ...
  return (
    <div className="relative flex">
      ...
      <div
        ...
        className={`absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-aspro p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark ${
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_62_9787">
                <rect width="16" height="16" fill="aspro" />
              </clipPath>
            </defs>
          </svg>
          Edit
